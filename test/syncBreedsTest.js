...
describe('#breedDetails', () => {
  it('returns breed details for the Bombay Breed', () => {
    // we expect it to be a function, but what will it be?
  ...
  it('returns undefined if there is no text in the file', () => {
    // we expect it to be a function, but what will it be?
    const expectedDesc = undefined;
    const emptyCat = breedDetails('emptyCatBreed');
    assert.equal(expectedDesc, emptyCat);
  });
});